...
framep=Frame(fenetre,height=190,width=720,bg="green")
framep.place(x=0,y=230)
Label(framep,text='Pieds',font=(25)).place(x=630,y=250)
...
clf1=Label(text="Avant",bg='red')
clf2=Label(text="gauche",bg='red')
crf1=Label(text="Avant",bg='red')
crf2=Label(text="droit",bg='red')
clm1=Label(text="Milieu",bg='red')
clm2=Label(text="gauche",bg='red')
crm1=Label(text="Milieu",bg='red')
crm2=Label(text="droit",bg='red')
clt1=Label(text="Arrière",bg='red')
clt2=Label(text="gauche",bg='red')
crt1=Label(text="Arrière",bg='red')
crt2=Label(text="droit",bg='red')

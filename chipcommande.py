...
pfw1=bouton('fw1',1,'192.168.1.117','pied')
pieds.append(pfw1)
pbw1=bouton('bw1',2,'192.168.1.117','pied')
pieds.append(pbw1)
pfw2=bouton('fw2',3,'192.168.1.117','pied')
pieds.append(pfw2)
pbw2=bouton('bw2',4,'192.168.1.117','pied')
pieds.append(pbw2)
pfw3=bouton('fw3',5,'192.168.1.117','pied')
pieds.append(pfw3)
pbw3=bouton('bw3',6,'192.168.1.117','pied')
pieds.append(pbw3)
pfw4=bouton('fw4',7,'192.168.1.117','pied')
pieds.append(pfw4)
pbw4=bouton('bw4',8,'192.168.1.117','pied')
pieds.append(pbw4)

pfw=bouton('pw',[1,3,5,7],'192.168.1.117','pied')
pbw=bouton('bw',[2,4,6,8],'192.168.1.117','pied')
pieds.append(pfw)
pieds.append(pbw)
